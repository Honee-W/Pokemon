...
/**
 * 加载所有玩家以及地图贴图，地图要素，怪物，NPC的图像数据方便查找
 * 由于除玩家外其他要素要呈现动态运动，需要用两帧图像循环播放，所以会有两个要素HashMap
 */
public class ImageData {
    ...
    //加载玩家图案
    public static HashMap<Integer, BufferedImage> playerMap0 = new HashMap<>();
    public static HashMap<Integer, BufferedImage> playerMap1 = new HashMap<>();
    //第一帧图像
    ...
    static {
        try {
            ...
            // 玩家 控制图片
            playerMap0.clear();
            playerMap0.put(PLAYER_LEFT, ImageIO.read(new File(System.getProperty("user.dir") + "/res/player/left0.png")));
            playerMap0.put(PLAYER_DOWN, ImageIO.read(new File(System.getProperty("user.dir") + "/res/player/down0.png")));
            playerMap0.put(PLAYER_RIGHT, ImageIO.read(new File(System.getProperty("user.dir") + "/res/player/right0.png")));
            playerMap0.put(PLAYER_UP, ImageIO.read(new File(System.getProperty("user.dir") + "/res/player/up0.png")));

            playerMap1.clear();
            playerMap1.put(PLAYER_LEFT, ImageIO.read(new File(System.getProperty("user.dir") + "/res/player/left1.png")));
            playerMap1.put(PLAYER_DOWN, ImageIO.read(new File(System.getProperty("user.dir") + "/res/player/down1.png")));
            playerMap1.put(PLAYER_RIGHT, ImageIO.read(new File(System.getProperty("user.dir") + "/res/player/right1.png")));
            playerMap1.put(PLAYER_UP, ImageIO.read(new File(System.getProperty("user.dir") + "/res/player/up1.png")));
